...
OnePanelChart(pp,"c_03_05_01_sahm_trigger_us.png","*3-mo m.a. **NBER definition. Source: BLS (via FRED).")
...
pp <- pp + geom_hline(yintercept=0,color=BondEconomicsBlue(),size=1)
pp <- pp + geom_hline(yintercept=0.5,color="red",size=1, linetype=3)
OnePanelChart(pp,"c_03_05_02_sahm_trigger_ca.png","*3-mo m.a. **C.D. Howe definition. Source: Statscan.")
...
pp <- pp + geom_hline(yintercept=0,color=BondEconomicsBlue(),size=1)
OnePanelChart(pp,"c_03_05_03_ur_indicator_comparison.png","Source: BLS (via FRED).")
#-----------------------------------------------------------
...
TwoPanelChart(pp, p2, "c_03_05_04_emratio.png","*NBER definition. Source: BLS (via FRED).")
