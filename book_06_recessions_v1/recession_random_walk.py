...
Note that this file was taken from my "simplepricers" module. 
...
try:
    ...
    print('Note: this code uses plotting routine found in the SimplePricers module.')
    print('It will crash when it hits the plotting code.')
    print('SimplePricers is found on GitHub, under user brianr747.')
