...
pp <- SetXAxis(pp,"1948-01-01", 5)

OnePanelChart(pp,"c_02_03_03_long_term_unemployed.png","*Greater than 27 weeks. Shade indicats NBER recessions. Source: BLS (via FRED).")
